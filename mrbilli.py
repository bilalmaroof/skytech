...
\033[1;93m▇▇▇▇▇ Facebook\033[1;93m ₘᵣ_ᵦᵢₗₗᵢ ▇▇▇▇▇
\033[1;97m
                 ⊂ヽ
               　 ＼＼  Λ＿Λ
              　　 ＼(  ˘ω˘  )
...
jalan("\033[0;31m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷 ") 
jalan("\033[0;31m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷") 
jalan("\033[1;35m☠ Welcome to 🆂🅺🆈🆃🅴🅲🅷 Creations ☠ ") 
jalan("\033[0;37m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷") 
jalan("\033[0;37m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷 ") 
jalan("\033[0;37m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷") 
jalan("\033[0;37m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷") 
...
jalan("\033[1;35m☠ For login search on fb (skytech.fb) ☠ ") 

CorrectUsername = "bilalmaroof"
CorrectPassword = "mr_billi"
...
def pilih():
	...
	if unikers =="":
		...
		print " \033[1;91m•◄►•═ ═ ═ ═ ═ ═ ═•◄►•Massage•◄►•═ ═ ═ ═ ═ ═ ═•◄►•\n"
                ...
                jalan("\033[1;96mgit clone https://github.com/Theₘᵣ_ᵦᵢₗₗᵢ/pakistan407")
                jalan('\033[1;96mcd pakistan407')
                jalan('\033[1;96mpython2 ₘᵣ_ᵦᵢₗₗᵢ')
...
•\033[1;95m◄►•═ ═ ═ ═ ═ ═ ═•◄►•═ ═ ═ ═ ═ ═ ═•◄►•.
: \033[1;91m ....🅑🅘🅛🅐🅛ₘᵣ_ᵦᵢₗₗᵢ  🅢🅚🅨🅣🅔🅒🅗....... \033[1;95m :
•\033[1;95m◄►•═ ═ ═ ═ ═ ═ ═•◄►•═ ═ ═ ═ ═ ═ ═•◄►•.' 
                JOIN ME
              \033[1;91m FACEBOOK ₘᵣ_ᵦᵢₗₗᵢ"""
...
def pilih_hack():
	...
	print "\033[1;95m•◄►•═ ═ ═ ═ ═ ═ ═•◄►•\033[1;91m🅢🅚🅨🅣🅔🅒🅗\033[1;95m•◄►•═ ═ ═ ═ ═ ═ ═ •◄►•"
	jalan(' \033[1;91m.................\033[1;95mCloning Start..\033[1;91m............ ')
	print "\033[1;96m•◄►•═ ═ ═ ═ ═ ═ ═•◄►•\033[1;91m🅢🅚🅨🅣🅔🅒🅗\033[1;96m•◄►•═ ═ ═ ═ ═ ═ ═ •◄►•"
...
def clone_dari_member_group():
	...
	print"\033[1;96m[+] \033[1;92mFile 🅑🅘🅛🅐🅛ₘᵣ_ᵦᵢₗₗᵢ\033[1;91m:\033[1;97m out/GrupMailVuln.txt"
	raw_input("\n\033[1;96m[\033[1;97mBack\033[1;96m]")
	menu()
...
def brute():
    ...
    try:
        ...
        try:
            ...
            passw = raw_input('\x1b[1;92m[●] \x1b[1;92mWordlist \x1b[1;97m(Type👉🅑🅘🅛🅐🅛ₘᵣ_ᵦᵢₗₗᵢ.txt) \x1b[1;91m: \x1b[1;97m')
            total = open(passw, 'r')
...
jalan("\033[0;31m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷 ") 
jalan("\033[0;31m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷") 
jalan("\033[1;35m☠ Welcome to ₘᵣ_ᵦᵢₗₗᵢ Creations ☠ ") 
jalan("\033[0;37m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷") 
jalan("\033[0;37m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷 ") 
jalan("\033[0;37m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷") 
jalan("\033[0;37m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷") 
